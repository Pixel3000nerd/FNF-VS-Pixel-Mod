...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'pixel':
				tex = Paths.getSparrowAtlas('Pixel_FNF_assetss');
				frames = tex;
				animation.addByPrefix('idle', "Pixel Idle Dance0", 24);
				animation.addByPrefix('singUP', 'Pixel Up note0', 24, false);
				animation.addByPrefix('singDOWN', 'Pixel Down Note0', 24, false);
				if (isPlayer)
				{
					animation.addByPrefix('singLEFT', 'Pixel Note left0', 24, false);
					animation.addByPrefix('singRIGHT', 'Pixel Note Right0', 24, false);
				}
				else
				{
					animation.addByPrefix('singLEFT', 'Pixel Note Right0', 24, false);
					animation.addByPrefix('singRIGHT', 'Pixel Note left0', 24, false);
				}
				...
				addOffset("singUP", 65, 175);
				addOffset("singRIGHT", -10, 150);
				addOffset("singLEFT", 10, 140);
				addOffset("singDOWN", -24, 55);
			...
			case 'pixelmad':
				tex = Paths.getSparrowAtlas('PixelMad_FNF_assetss');
				frames = tex;
				animation.addByPrefix('idle', "Pixel Idle Dance0", 24);
				animation.addByPrefix('singUP', 'Pixel Up note0', 24, false);
				animation.addByPrefix('singDOWN', 'Pixel Down Note0', 24, false);
				...
				addOffset('idle', 0, 138);
				addOffset("singUP", 65, 175);
				addOffset("singRIGHT", -10, 148);
				addOffset("singLEFT", 17, 155);
				addOffset("singDOWN", -29, 65);
